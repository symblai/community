...
mkdir -p $working_dir
cd $working_dir
git clone git@github.com:$user/`[your forked repo]`.git

cd $working_dir/`[your forked repo]`
git remote add upstream git@github.com:symblai/`[your forked repo]`.git
...
1. Visit your fork at `https://github.com/<user>/[your forked repo]`
2. Click the **Compare & Pull Request** button next to your `myfeature` branch.
3. Submit your Pull Reuqest
